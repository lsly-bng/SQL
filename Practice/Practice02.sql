...
문제 1.
	...
	-havMngCnt -> 106
*/
select count (manager_id) "havMngCnt"
from employees
...
*/
select to_char(min(hire_date), 'YYYY-MM-DD DAY') longest_hire
from employees;
...
/*
문제 9.
	- 2005년 이후 입사자 중 관리자 별로 평균급여, 최소급여, 최대급여를 알아보려고 한다.
	- 출력은 관리자별로 
	- 평균급여가 5000이상 중에 
...
select first_name ||' '|| last_name 직원명,
        salary 급여,
		hire_date 입사일,
        case when hire_date<='31-DEC-2002' then '창립멤버'
             when hire_date between '01-JAN-2003'and '31-DEC-2003' then '03년입사'
             when hire_date between '01-JAN-2004' and '31-DEC-2004' then '04년입사'
             else '상장이후입사'
        END optDate
from employees
...
select  first_name ||' '|| last_name 직원명,
		...
		hire_date 입사일,
        case when hire_date <='31-DEC-2002' then '창립멤버'
             when hire_date >= '01-JAN-2003' and hire_date <= '31-DEC-2003' then '03년입사'
             when hire_date >= '01-JAN-2004' and hire_date <= '31-DEC-2004' then '04년입사'
             else '상장이후입사'
        END optDate
from employees
order by hire_date asc;
